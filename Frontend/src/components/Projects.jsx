  ...
  return (
    <div className="text-white max-w-6xl mx-auto px-4 md:mt-80 md:px-4">
      ...
      <div className="md:flex md:space-x-8">
        <div className="grid grid-cols-2 gap-4 max-w-96 border border-transparent md:max-w-full md:hover:border-bronze md:hover:shadow-md md:hover:shadow-bronze md:rounded-md md:p-2 mx-auto">
          ...
          <div className="block md:grid md:grid-rows">
            ...
            <div className="flex mt-4 gap-4 text-lg">
              <a href="https://github.com/jimmindungu3/Tiketa" target="_blank">
                <FaGithub />
              </a>
              <a href="https://tiketa.vercel.app/" target="_blank">
                <FaRocket />
              </a>
            </div>
          </div>
        ...
        {/* JAMES STORE */}
        <div className="mt-16 grid grid-cols-2 gap-4 max-w-96 border border-transparent md:max-w-full md:hover:border-bronze md:hover:shadow-md md:hover:shadow-bronze md:rounded-md md:p-2 mx-auto md:mt-0">
